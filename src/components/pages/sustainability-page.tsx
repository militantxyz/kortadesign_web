  ...
  return (
    <>
      ...
      <section className="grid grid-cols-[1fr_0.9fr] bg-[#e8ece6] max-lg:grid-cols-1">
        <img className="h-full min-h-[620px] w-full object-cover max-lg:min-h-[420px]" src={asset("2025/01/DSC9674-min-1536x1025.jpg")} alt="Natural stone outdoor environment" />
