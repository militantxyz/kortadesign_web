...
const baseProducts: Product[] = [
  {
    ...
    heroImage: localAsset("aqua-products/odino/hero.jpg"),
    gallery: [
      localAsset("aqua-products/odino/slide-1.png"),
      localAsset("aqua-products/odino/slide-2.png"),
      localAsset("aqua-products/odino/slide-3.jpg"),
    ],
  ...
  },
  {
    ...
    heroImage: localAsset("aqua-products/marbella/hero.jpg"),
    gallery: [
      localAsset("aqua-products/marbella/slide-1.jpeg"),
      localAsset("aqua-products/marbella/slide-2.jpg"),
      localAsset("aqua-products/marbella/slide-3.webp"),
    ],
    formTitle: "Create Your Perfect Shower",
    materials: showerMaterials,
  ...
  },
  {
    ...
    heroImage: localAsset("aqua-products/minno/hero.png"),
    gallery: [
      localAsset("aqua-products/minno/slide-1.png"),
      localAsset("aqua-products/minno/slide-2.png"),
      localAsset("aqua-products/minno/slide-3.png"),
    ],
    formTitle: "Create Your Perfect Shower",
    materials: showerMaterials,
    additions: showerAdditions,
  ...
  },
  {
    ...
    heroImage: localAsset("aqua-products/kada/hero.png"),
    gallery: [
      localAsset("aqua-products/kada/slide-1.png"),
      localAsset("aqua-products/kada/slide-2.png"),
      localAsset("aqua-products/kada/slide-3.png"),
    ],
  ...
  },
  {
    ...
    heroImage: localAsset("gallery/cara/hero-cara.jpg"),
    gallery: [
      localAsset("gallery/cara/cara-gallery-1.jpg"),
      localAsset("gallery/cara/cara-gallery-2.jpeg"),
      localAsset("gallery/cara/cara-gallery-3.jpg"),
    ],
